    ...
    public partial class ConfigView
    {
        public ConfigView()
        {
            ...
            this.WhenActivated(d =>
            {
                ...
                this.Bind(ViewModel, viewModel => viewModel.SelectedRootPath, view => view.RootPathItems.SelectedItem);
                this.Bind(ViewModel, viewModel => viewModel.SelectedAppModel, view => view.AppNameItems.SelectedItem);
                this.Bind(ViewModel, viewModel => viewModel.SelectedMatchedApplication, view => view.MatchedAppItems.SelectedItem);

                this.BindCommand(ViewModel, viewModel => viewModel.AddRootPath, view => view.AddRootPath);
                this.BindCommand(ViewModel, viewModel => viewModel.RemoveRootPath, view => view.RemoveRootPath);
                this.BindCommand(ViewModel, viewModel => viewModel.AddApplication, view => view.AddApplication);
                this.BindCommand(ViewModel, viewModel => viewModel.RemoveApplication, view => view.RemoveApplication);
